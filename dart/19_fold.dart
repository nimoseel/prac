// reduce의 경우 시작값을 생략, 실행하는 리스트 타입과 같은 타입을 리턴해야 실행할 수 있음
...
void main() {
  ...
  final usingReduce = words.reduce((prev, next) => prev + next.length);
  print(
      usingReduce); // A value of type 'int' can't be assigned to a variable of type 'String'.
}
